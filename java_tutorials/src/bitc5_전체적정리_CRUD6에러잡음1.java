...
public class bitc5_전체적정리_CRUD6에러잡음1 {
    ...
    public static void main(String args[]) {
        ...
        do {  //do while 반복문: 일단 실행 시키고 while에서 그만 할건지 판단
            ...
            //실행되는 상황? 지금 실행 되고 있음하지만 else로 둘러싸면 list가 아닐때
...
//-----------------------------
//String snum = kb.nexLine();  //문자열 입력
//  int num = Integer.parseInt(snum); //문자열 받아서 정수로 바꾼다
//}
//이부분을 빼고 아래로 할 수도 있음
