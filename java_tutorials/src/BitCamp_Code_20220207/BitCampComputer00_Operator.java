...
public class BitCampComputer00_Operator {
	//main method
	public static void main(String[] args) {
		...
		int temp = value++;		//temp=value++의미 :value의 값을 temp대입 후 자기자신 1증가
		//int temp = value--;	//temp=value--의미 :value의 값을 temp대입 후 자기자신 1감소
		//int temp = ++value;	//temp=++value의미 :value 자기자신에 1증가 그값 temp대입
		//int temp = --value;	//temp=--value의미 :value 자기자신에 1감소 그값 temp대입
		...
		//int temp04 = (1=<2)? 3:4; <==compile erroe 확인
